...
3. **判決剪貼簿側邊欄（瀏覽器側邊欄）**
   ...
   - **#標籤**：每張卡片可加入自訂 hashtag，以 Obsidian 風格的彩色 pill 顯示在卡片上，顏色跟隨來源主題；搜尋列下方自動彙整所有標籤，點擊即可快速篩選
...
| **耳標位置** | 司法院內網（intraj）左 / 右 | 同上，內網獨立設定 | 左 |
...
| 司法院內網法令判解系統 | `https://legal.law.intraj/FLAW/*` | 內網法令判解系統，套用海軍藍專屬主題 |
