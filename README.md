...
### 🔵 Safari on macOS → GitHub Release

👉 **<https://github.com/han0302-cyber/judicial-outline-extension/releases/latest>**

1. 在 Release 頁面下載最新的 `司法院裁判書閱讀助手-X.X.X.dmg`
2. 雙擊開啟 DMG → 把 `.app` 拖到 **Applications** 資料夾
